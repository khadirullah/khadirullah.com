...
Set up Kubernetes clusters with Deployments, Services, RBAC, Network Policies, Ingress controllers, and security contexts — on both local VMs and AWS.
...
{{< alert "email" >}}
I'm actively looking for **DevOps Engineer**, **Cloud Engineer**, and **Infrastructure Engineer** roles.
{{< /alert >}}
